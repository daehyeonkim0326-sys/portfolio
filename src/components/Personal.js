...
const slides = [
  { img: quiz, 
    ...
    figma:"https://www.figma.com/design/ltVcUOvZ2D02BnXy78CWqf/Quiz?node-id=117-197&t=n3iBKx9FyqIHxoOO-1",
    description: "json를 이용한 질문 데이터를 ai를 활용하여 제작한 quiz 사이트 입니다.",
    dday:"1.진행 기간:2025.09.10~ 2025.09.12 (3일)",
  ...
  { img: shopping, 
    ...
    description: "json data를 활용하여 카테고리 리스트를 만들고 useEffect를 통해 물건이 장바구니에 담기는 기능을 구현한 쇼핑몰 사이트 입니다.",
    dday:"1.진행 기간:2025.11.10~ 2025.11.14 (5일)",
    people:"2.개발 인원: FrontEnd 1인 (Solo Project)",
    techstack:"3.사용 기술 스택:\nLanguage: JavaScript (ES6+)\nFramework: React.js\nStyling: SCSS\nData Handling: json data(mock data)\nDesign & Tool: Git, GitHub, photoshop",
